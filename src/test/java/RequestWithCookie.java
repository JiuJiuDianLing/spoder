...
public class RequestWithCookie {
    ...
    public static void main(String[] args) throws URISyntaxException, IOException, ClassNotFoundException {
        ...
        //待请求的地址
        String url = "https://www.zhihu.com/people/jimmy1860/answers";
        ...
        saveCookieStore(cookieStore,"E:\\IntellIJ\\spiderFile\\cookie.txt");

        //下面我们将演示如何使用Cookie来请求，首先我们将之前的Cookie读出来
        CookieStore cookieStore1 = readCookieStore("E:\\IntellIJ\\spiderFile\\cookie.txt");
